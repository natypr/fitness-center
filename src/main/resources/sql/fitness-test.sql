...
VALUES (1, 0, 'Админ', 'Админ', 'M', 17, 'admin@gmail.com', '200ceb26807d6bf99fd6f4f0d1ca54d4', 0,
        '2019-12-01 00:00:00'),
       (2, 1, 'Виталий', 'Морозов', 'M', 36, 'morozov@gmail.com', '54e25ae8633f344209e582f90f0574c5', 0,
        '2019-12-01 00:00:00'),
       (3, 1, 'Светлана', 'Демчук', 'F', 29, 'demchuk@gmail.com', '28c60845a864afeaa07e6909cf105c67', 0,
        '2019-12-01 00:00:00'),
       (4, 2, 'Екатерина', 'Веремеева', 'F', 23, 'veremeeva@gmail.com', 'b61006c0cd3e40c55f39f2be19379a30', 0,
        '2019-12-01 00:00:00');
...
INSERT INTO order (id, type_of_workout, number_of_workout, id_trainer, equipment, description, id_client, is_paid,
                   date_of_order)
    VALUE (1, 'power', 26, 2, 'Гантели', 'Умеренная тренировка', 4, 0, '2019-12-01 00:00:00'),
    (2, 'aerobic', 35, 3, 'Коврик', 'Легкая нагрузка', 4, 0, '2019-12-01 00:00:00');
